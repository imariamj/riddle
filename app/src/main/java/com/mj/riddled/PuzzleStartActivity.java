 ...
 */
public class PuzzleStartActivity extends AppCompatActivity {
    int categoryId = -1;
        ...
        if (bundle != null) {
            ...
            if(category != null){
                if (startPuzzleTextView != null) {
                    startPuzzleTextView.setText(DummyData.getCategoryDesc(category));
                }
            }
        }
    ...
    public void startPuzzle(int categoryId) {
        ...
        Intent intent = new Intent(PuzzleStartActivity.this, QuestionsActivity.class);
