...
import com.mj.riddled.PuzzleStartActivity;
 ...
 * PuzzleAdapter : Creates view for list of quiz categories
 */
    ...
    public View getView(final int position, View rowView, ViewGroup parent){
        ...
        ivImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent puzzleIntent = new Intent(getContext(), PuzzleStartActivity.class);
